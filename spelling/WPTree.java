...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
	   ...
	   while(!queue.isEmpty())
	   {
		   ...
		   List<String> returnedWords = this.nw.distanceOne(curNode.getWord(), false);
		   
		   for(String returnedString : returnedWords)
		   {
			   if(!visited.contains(returnedString))
			   {
				   WPTreeNode childNode = new WPTreeNode(returnedString, curNode);
	...
	{
		WPTree newTree = new WPTree();
		
		List<String> list = newTree.findPath("time", "theme");
