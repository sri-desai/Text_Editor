...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		System.out.print("Text Length" + "\t" + "Basic Document" + "\t" + "Efficient Document" + "\n");
				...
				numToCheck += increment)
		{
			...
			BasicDocument bDoc = new BasicDocument(strFromFile);			
			bDoc.getFleschScore();			
			long endTime = System.nanoTime();			
			System.out.print( ((endTime - startTime) / 1000000000.00) + "\t");
			
			/* Efficient Document */
			startTime = System.nanoTime();			
			EfficientDocument eDoc = new EfficientDocument(strFromFile);			
			eDoc.getFleschScore();
